...
namespace HotelListingApi.Repository
{
    public class AuthManager : IAuthManager
    {
        ...
        public async Task<AuthResponseDto> Login(ApiLoginDto apiLoginDto)
        {

            _user = await _userManager.FindByEmailAsync(apiLoginDto.Email);
            var isValidPassword = await _userManager.CheckPasswordAsync(_user, apiLoginDto.Password);

            if (_user == null || !isValidPassword) return null;
